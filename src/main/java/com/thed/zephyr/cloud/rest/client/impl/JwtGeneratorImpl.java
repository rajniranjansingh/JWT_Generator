...
public class JwtGeneratorImpl implements JwtGenerator 
{
	...
	public String generateJWT(String requestMethod, URI uri, int jwtExpiryWindowSeconds) 
	{
		...
		{
			public Option<String> generate(HttpMethod httpMethod, URI url, Map<String, List<String>> parameters, AcHost acHost, Option<String> userId)
							throws JwtIssuerLacksSharedSecretException, JwtUnknownIssuerException 
			{
				...
				return Option.some(JWT_AUTH_HEADER_PREFIX + encodeJwt(httpMethod, url, paramsAsArrays, userId.getOrNull(), acHost));
			}
